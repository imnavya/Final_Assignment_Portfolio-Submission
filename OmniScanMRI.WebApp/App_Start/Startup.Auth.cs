...
namespace OmniScanMRI.WebApp
{
    public partial class Startup
    {
        ...
        public void ConfigureLocalAuth(IAppBuilder app)
        {
            app.CreatePerOwinContext(OmniScanContext.Create);
            ...
            app.UseOpenIdConnectAuthentication(
                new OpenIdConnectAuthenticationOptions
                {
                    ...
                    Notifications = new OpenIdConnectAuthenticationNotifications()
                    {
                        ...
                        {
                            if (context.ProtocolMessage.RequestType.ToString() == "AuthenticationRequest")
                            {
                        ...
                        SecurityTokenValidated = context =>
                        {
                            ...
                            string name = claimsIdentity.FindFirst("preferred_username")?.Value;
                            if (!string.IsNullOrEmpty(name))
                            {
                                claimsIdentity.AddClaim(new Claim(ClaimTypes.Name, name, string.Empty));
                            }


                            if (claimsIdentity.HasClaim(c => c.Type == "roles"))
                            {
